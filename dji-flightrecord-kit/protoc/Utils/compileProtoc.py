...
def compileObjectiveC(protocFilePath, outputPath):
    ...
    resultStr = os.popen("C:/Users/Titouan/workspace/protoc-31.1/bin/protoc " + protocFilePath + " --proto_path=" + fileParentFolder + " --objc_out=" + outputPath).read()
    print(resultStr)
...
def compileCpp(protocFilePath, outputPath):
    ...
    fileFolder = os.path.dirname(protocFilePath);
    fileParentFolder = os.path.dirname(fileFolder)
    resultStr = os.popen("C:/Users/Titouan/workspace/protoc-31.1/bin/protoc " + protocFilePath + " --proto_path=" + fileParentFolder + " --cpp_out=" + outputPath).read()
    print(resultStr)
